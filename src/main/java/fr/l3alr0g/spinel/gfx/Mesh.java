...
public class Mesh {
     ...
     * @param indices  an array of indices which is used to link the vertices and
     *                 form triangles
     *                 <p>
     *                 structure : [vertex_index1_triangle1,
     *                 vertex_index2_triangle1, vertex_index3_triangle1,
     *                 vertex_index1_triangle2, vertex_index2_triangle2,
     *                 vertex_index3_triangle2, etc...]
     *                 </p>
     *                 the vertex indices depend on the order of the vertices
     ...
     * Define a mesh with no material.
     * 
     * @param vertices a List of {@link Vertex} objects containing all the vertices
     *                 of the mesh
     * @param indices  a List of Integer ojects containing the indices which are
     *                 used to link the vertices
     * @see #Mesh(Vertex[], int[])
     */
     ...
     * @param vertices a List of {@link Vertex} objects containing all the vertices
     *                 of the mesh
     * @param indices  a List of Integers containing the indices which are used to
     *                 link the vertices
     * @param material a material which may contain a texture
    ...
    /**
     * Free all the buffers, the vertex array object and the material, if present.
     */
    public void destroy() {
